...
class Music(commands.Cog):
    ...
    @commands.command(name='join', invoke_without_subcommand=True,description='Joins your voice channel.')
    ...
    @commands.command(name='summon',description='Same as the Join command.')
    ...
    @commands.command(name='leave', aliases=['disconnect'],description='Leaves the voice channel.')
    #@commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='now', aliases=['current', 'playing'],description='Displays the current song')
    ...
    @commands.command(name='resume',description='Resumes a song')
    #@commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='stop',description='Clears the queue')
    #@commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name='remove',description='Removes a song')
    ...
    @commands.command(name='loop',description='Loops or Unloops the song')
    ...
    # @commands.command(name='musicinfo',description='Gives you info on this music stuff')
    # async def musicinfo(self, ctx):
    #     mInfoEmbed=discord.Embed(title='Music Info',description='This music stuff was created by vbe0201 on Github.\n[Github Page](https://gist.github.com/vbe0201/ade9b80f2d3b64643d854938d40a0a2d)')
    #     await ctx.send(embed=mInfoEmbed)
def setup(client):
